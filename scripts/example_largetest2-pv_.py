...
# Suppress "torch_dtype is deprecated" warnings
...
# Manually create attention mask to avoid "The attention mask is not set" warning
# The model doesn't automatically create one when pad_token == eos_token
