...
# Suppress specific warnings as per instructions
...
# Note: This function preloads and pins a specified number of model layers to CPU RAM to optimize the load-compute-unload cycle.
# This operation occurs before prompt processing, making associated logs appear early in the execution flow.
...
# Removed reasoning_effort argument as it is not supported
...
# Explicitly create attention_mask as required when batch size is 1 and pad_token_id == eos_token_id
